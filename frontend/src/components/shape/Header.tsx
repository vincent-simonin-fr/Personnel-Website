...
//   return (
//     <AnimatedDiv
//       className={`sticky top-0 z-50 h-14 w-full sm:min-w-[675px] md:min-w-[675px]`}
//       style={width}>
//       {/* <Navbar
...
//       <Navbar
//         className={`transition-transform-colors-opacity mt-1 h-10 w-full bg-transparent text-nowrap *:max-w-full ${isMobile ? 'rounded-none' : 'rounded-full'} ${isMenuOpen ? 'backdrop-blur-none backdrop-saturate-100 data-[menu-open=true]:backdrop-blur-none' : ''}`}
//         isMenuOpen={isMenuOpen}
//         onMenuOpenChange={setIsMenuOpen}>
//         <NavbarContent className='pr-3 sm:hidden'>
